...
alertOk.onclick = (e)=>{
    shell.openExternal("https://github.com/TenDRILLL/Nervegear/releases");
}

alertCancel.onclick = (e)=>{
...
function changeBackground(value){
    switch(value){
        case "menu":
            ...
            break;
        case "sao":
            document.body.style.backgroundImage = "url('../images/saobg.png')";
            canvas.style.visibility = "hidden";
            break;
        case "alo":
            document.body.style.backgroundImage = "url('../images/alobg.png')";
            canvas.style.visibility = "hidden";
            break;
        case "ggo":
            document.body.style.backgroundImage = "url('../images/ggobg.png')";
            canvas.style.visibility = "hidden";
            break;
        case "alice":
            document.body.style.backgroundImage = "url('../images/uwbg2.png')";
            canvas.style.visibility = "hidden";
            break;
        default:
            document.body.style.backgroundImage = "";
